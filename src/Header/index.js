      ...
      <div className="app-header">
        ...
        <div className="input-options">
          <div className="game-options-form players">
            ...
            <input type="number" id="choose-players-input" value={_numOfPlayers} onChange={this.updateNumOfPlayers} min="2" max="26"/>
          </div>
          <div className={gameOptionsFormCards}>
            <label htmlFor="choose-cards-input">Choose Number Of Cards To Be Dealt</label>
            <input type="number" id="choose-cards-input" value={_numOfCards} onChange={this.updateNumOfCards} min="1" max="52"/>
          </div>
          <button
